...
const RidesScreen = () => {
  ...
  const fetchRides = useCallback(async () => {
    ...
    try {
      const data: any = await apiUtils.get('/api/ride/driver/rides', {});
      console.log(data)
        ...
        {loading ? (
          ...
          filteredRides.map((ride, idx) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('RidesHistoryDetailsScreen', { ride })}
            >
              <View style={styles.rowBetween}>
                ...
                <View style={styles.fareInfo}>
                  ...
                  <Text style={styles.value}>{ride.earnings}</Text>
                </View>
              </View>
